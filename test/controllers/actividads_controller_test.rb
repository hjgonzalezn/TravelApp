...
class ActividadsControllerTest < ActionController::TestCase
  ...
  test "should create actividad" do
    assert_difference('Actividad.count') do
      post :create, actividad: { actv_estado_registro: @actividad.actv_estado_registro, actv_nombre: @actividad.actv_nombre }
    end
  ...
  test "should update actividad" do
    patch :update, id: @actividad, actividad: { actv_estado_registro: @actividad.actv_estado_registro, actv_nombre: @actividad.actv_nombre }
    assert_redirected_to actividad_path(assigns(:actividad))
  end
