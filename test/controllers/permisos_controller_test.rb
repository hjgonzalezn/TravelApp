...
class PermisosControllerTest < ActionController::TestCase
  ...
  test "should create permiso" do
    assert_difference('Permiso.count') do
      post :create, permiso: { funcionalidad_id: @permiso.funcionalidad_id, perfil_id: @permiso.perfil_id }
    end
  ...
  test "should update permiso" do
    patch :update, id: @permiso, permiso: { funcionalidad_id: @permiso.funcionalidad_id, perfil_id: @permiso.perfil_id }
    assert_redirected_to permiso_path(assigns(:permiso))
  end
