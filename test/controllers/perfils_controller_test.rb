...
class PerfilsControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { prf_descripcion: @perfil.prf_descripcion, prf_estado_registro: @perfil.prf_estado_registro, prf_nombre: @perfil.prf_nombre }
    end
  ...
  test "should update perfil" do
    patch :update, id: @perfil, perfil: { prf_descripcion: @perfil.prf_descripcion, prf_estado_registro: @perfil.prf_estado_registro, prf_nombre: @perfil.prf_nombre }
    assert_redirected_to perfil_path(assigns(:perfil))
  end
